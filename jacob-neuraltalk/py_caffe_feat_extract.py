...
def caffe_extract_feats(path_imgs , batch_size = 10 ):
    '''
    ...
    for b in range(0 , len(path_imgs) , batch_size):
        ...
        word_predictions  = list(caffe_net.blobs["fc8"].data[0])
        print word_predictions
        print word_predictions.shape
...
def gen_feats(path_img , out_path, batch_size = 10 ):
    feats, word_predictions = caffe_extract_feats([path_img] , 10 )
    vgg_feats = {}

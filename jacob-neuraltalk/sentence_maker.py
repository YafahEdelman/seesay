...
def get_sentence(file_path):
    ...
    ret = predict_on_images.get_sentences(file_path, "temp_feats").replace("man","person").replace("woman","person").replace("he","they").replace("she","they").replace("men","people").replace("women","people")
